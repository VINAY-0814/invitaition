    ...
    <section ref={ref} className="relative h-screen w-full overflow-hidden bg-background">
      ...
      >
        ...
        <button
          type="button"
          onClick={toTop}
          aria-label="Scroll back to top and replay the film"
          className="group mt-12 inline-flex items-center gap-2 rounded-full border border-primary/40 bg-background/40 px-5 py-2.5 text-primary backdrop-blur-md transition-all duration-300 hover:border-primary hover:bg-background/60 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 focus:ring-offset-background"
        >
